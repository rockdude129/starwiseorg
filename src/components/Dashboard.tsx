      ...
      <Dialog open={showProModal} onOpenChange={setShowProModal}>
        <DialogContent className="backdrop-blur-2xl bg-white/10 border border-white/20 shadow-2xl rounded-2xl max-w-lg mx-auto">
          ...
          <ul className="my-6 space-y-4 text-white/90 text-lg">
            <li>NOTE: COMING SOON. Listed Below are the features that will be available in the future.</li>
          ...
          <DialogFooter>
            {/*
            <Button className="bg-gradient-to-r from-yellow-400 to-purple-500 text-white font-semibold px-6 py-2 rounded-lg shadow-lg hover:scale-105 transition-all" onClick={() => }>
              Upgrade Now
            </Button>
            */}
